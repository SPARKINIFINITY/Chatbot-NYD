...
def query():
    try:
        ...
        retrieved = retriever.retrieve(q, top_k=top_k, use_bm25=use_bm25, use_multiquery=use_multiquery, use_rerank=use_rerank)
...
def ask():
    try:
        ...
        results = retriever.retrieve(question, top_k=5, use_bm25=True, use_multiquery=True, use_rerank=True)
